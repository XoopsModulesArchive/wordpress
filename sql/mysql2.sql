...
INSERT INTO wp2_categories (`cat_ID`, `cat_name`, `category_nicename`, `category_description`, `category_parent`)
...
INSERT INTO wp2_linkcategories (`cat_id`, `cat_name`, `auto_toggle`, `show_images`, `show_description`, `show_rating`, `show_updated`, `sort_order`, `sort_desc`, `text_before_link`, `text_after_link`, `text_after_all`, `list_limit`)
...
INSERT INTO wp2_links (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_category`, `link_description`, `link_visible`, `link_owner`, `link_rating`, `link_updated`, `link_rel`, `link_notes`, `link_rss`)
...
INSERT INTO wp2_optiongroup_options (`group_id`, `option_id`, `seq`)
VALUES (1, 48, 1);
INSERT INTO wp2_optiongroup_options (`group_id`, `option_id`, `seq`)
VALUES (1, 49, 2);
INSERT INTO wp2_optiongroup_options (`group_id`, `option_id`, `seq`)
...
INSERT INTO wp2_optiongroups (`group_id`, `group_name`, `group_desc`, `group_longdesc`)
...
INSERT INTO wp2_options (`option_id`, `blog_id`, `option_name`, `option_can_override`, `option_type`, `option_value`, `option_width`, `option_height`, `option_description`, `option_admin_level`)
...
INSERT INTO wp2_options (`option_id`, `blog_id`, `option_name`, `option_can_override`, `option_type`, `option_value`, `option_width`, `option_height`, `option_description`, `option_admin_level`)
VALUES (31, 0, 'use_fileupload', 'Y', 2, '0', 20, 8, '_LANG INST_BASE_VALUE31', 8);
INSERT INTO wp2_options (`option_id`, `blog_id`, `option_name`, `option_can_override`, `option_type`, `option_value`, `option_width`, `option_height`, `option_description`, `option_admin_level`)
...
INSERT INTO wp2_optiontypes (`optiontype_id`, `optiontype_name`)
VALUES (1, 'integer');
INSERT INTO wp2_optiontypes (`optiontype_id`, `optiontype_name`)
VALUES (2, 'boolean');
INSERT INTO wp2_optiontypes (`optiontype_id`, `optiontype_name`)
...
INSERT INTO wp2_optionvalues (`option_id`, `optionvalue`, `optionvalue_desc`, `optionvalue_max`, `optionvalue_min`, `optionvalue_seq`)
...
INSERT INTO wp2_post2cat (`rel_id`, `post_id`, `category_id`)
VALUES (1, 1, 1);
