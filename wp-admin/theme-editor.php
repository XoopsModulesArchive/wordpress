...
$wpvarstoreset = ['action', 'redirect', 'profile', 'error', 'warning', 'a', 'file', 'theme'];
                ...
                if ($allowed_files) :
                    ...
                    <ul>
                        <?php foreach ($allowed_files as $allowed_file) : ?>
                            <li><a href="theme-editor.php?file=<?php echo (string)$allowed_file; ?>&amp;theme=<?php echo urlencode($theme) ?>"><?php echo get_file_description($allowed_file); ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
            </div>
