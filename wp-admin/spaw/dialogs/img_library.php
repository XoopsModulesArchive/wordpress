...
//                                www.solmetra.com
// ================================================
// $Revision: 1.2 $, $Date: 2006/03/19 20:05:51 $
// ================================================
        ...
        <script language="javascript">
            ...
            function getImgUrl() {
                if (document.libbrowser.lib.selectedIndex >= 0 && document.libbrowser.imglist.selectedIndex >= 0) {
                    ...
                    <?php } elseif ('XoopsImage' == $libtype) { ?>
                    imgUrl = '<?php if ('file' == $imagetype) {
            ...
            <table border="0" cellpadding="2" cellspacing="0">
                                ...
                                if ($d) {
                                    while (false !== ($entry = $d->read())) {
                                        if (is_file($_root . $imglib . $entry)) {
                                            if (preg_match('^thumb-.*', $entry)) {
                                                continue;
                                            }

                                            if (preg_match('\.(jpg|jpeg|gif|png)', $entry)) {
                        ...
                        <?php } elseif ('XoopsImage' == $libtype) { ?>
                            <select name="imglist" size="15" class="input" style="width: 150px;" onchange="selectChange();" ondblclick="selectClick();">
                                ...
                                if ('file' == $imagetype) {
                                    ...
                                    while (false !== ($image = $xoopsDB->fetchArray($result))) {
                                        ?>
                ...
                <tr>
                    <td valign="top" align="left" colspan="3">
                        <input type='checkbox' name='zoom' value='1' <?php echo $zoom ? 'checked' : '' ?> onclick="selectChange();">Use Zoomed Image that hasn't Thumbnail:<input type='text' name='zoomrate' size='4' value='<?php echo $zoomrate ?>' onchange="selectChange();">%
                    </td>
                </tr>
                <tr>
                    <td valign="top" align="left" colspan="3">
