...
<div class="wrap">
    ...
    <form name="profile" id="your-profile" action="profile-update.php" method="post">
        ...
        <fieldset>
            ...
            <?php $profileuser->nickname = encoding_xoops2wp($xoopsUser->getVar('name', 'e')); ?>
            <p><label><?php _e('Nickname:') ?><br>
                    <input type="text" name="nickname" value="<?php echo $profileuser->nickname ?>" disabled="disabled"></label></p>
        ...
        <fieldset>
            <legend><a href="<?php echo XOOPS_URL . '/edituser.php'; ?>" target="edituser"><?php _e('Contact Info'); ?></a></legend>

            <p><label><?php _e('E-mail: (required)') ?><br>
                    <input type="text" name="email_disp" value="<?php echo $profileuser->user_email ?>" disabled="disabled"></label></p>
            <input type="hidden" name="email" value="<?php echo $profileuser->user_email ?>"></label></p>

            <p><label><?php _e('Website:') ?><br>
                    <input type="text" name="url" value="<?php echo $profileuser->user_url ?>" disabled="disabled">
                </label></p>

            <p><label><?php _e('AIM:') ?><br>
                    <input type="text" name="aim" value="<?php echo $profileuser->aim ?>" disabled="disabled">
                </label></p>

            <p><label><?php _e('Yahoo IM:') ?><br>
                    <input type="text" name="yim" value="<?php echo $profileuser->yim ?>" disabled="disabled">
                </label></p>

            <p><label><?php _e('Jabber / Google Talk:') ?>
                    <input type="text" name="jabber" value="<?php echo $profileuser->jabber ?>" disabled="disabled"></label>
            </p>
        </fieldset>
        <br clear="all">
        <fieldset>
            <legend><a href="<?php echo XOOPS_URL . '/edituser.php'; ?>" target="edituser"><?php _e('About yourself'); ?></a></legend>
            <p class="desc"><?php _e('Share a little biographical information to fill out your profile. This may be shown publicly.'); ?></p>
            <p><textarea name="description" rows="5" cols="30" disabled="disabled"><?php echo $profileuser->description ?></textarea></p>
        </fieldset>
        ...
        if ($show_password_fields) :
            ?>
            <fieldset>
                <legend><a href="<?php echo XOOPS_URL . '/edituser.php'; ?>" target="edituser"><?php _e('Update Your Password'); ?></a></legend>
                ...
                <p><label><?php _e('New Password:'); ?><br>
                        <input type="password" name="pass1" size="16" value="" disabled="disabled">
                    </label></p>
                <p><label><?php _e('Type it one more time:'); ?><br>
                        <input type="password" name="pass2" size="16" value="" disabled="disabled">
                    </label></p>
            </fieldset>
        <?php endif; ?>
