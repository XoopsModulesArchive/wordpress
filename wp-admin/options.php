    ...
    case 'update':
        ...
        if (!$_POST['page_options']) {
            foreach ((array)$_POST as $key => $value) {
                if (!in_array($key, ['_wpnonce', '_wp_http_referer'], true)) {
                    $options[] = $key;
                }
            }
        } else {
...
<td>";
                        ...
                        if (mb_stristr($value, "\n")) {
                            ...
                            echo "<input class='$class' type='text' name='$option->option_name' id='$option->option_name' size='30' value='" . $value . "'$disabled>";
                        }
