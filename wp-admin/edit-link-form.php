...
function xfn_check($class, $value = '', $type = 'check')
{
    ...
    $rels = preg_preg_split('/\s+/', $link_rel);
    ...
    if ('' == $value) {
        if ('family' == $class && !mb_strstr($link_rel, 'child') && !mb_strstr($link_rel, 'parent') && !mb_strstr($link_rel, 'sibling') && !mb_strstr($link_rel, 'spouse') && !mb_strstr($link_rel, 'kin')) {
            echo ' checked';
        }

        if ('friendship' == $class && !mb_strstr($link_rel, 'friend') && !mb_strstr($link_rel, 'acquaintance') && !mb_strstr($link_rel, 'contact')) {
            echo ' checked';
        }

        if ('geographical' == $class && !mb_strstr($link_rel, 'co-resident') && !mb_strstr($link_rel, 'neighbor')) {
            echo ' checked';
        }
    ...
    <fieldset class="options">
        ...
        <table class="editform" width="100%" cellspacing="2" cellpadding="5">
            ...
            <tr>
                ...
                <td><label>
                        <input type="radio" name="link_target" value="_blank" <?php echo(('_blank' == $link->link_target) ? 'checked' : ''); ?>>
                        <code>_blank</code></label><br>
                    <label>
                        <input type="radio" name="link_target" value="_top" <?php echo(('_top' == $link->link_target) ? 'checked' : ''); ?>>
                        <code>_top</code></label><br>
                    <label>
                        <input type="radio" name="link_target" value="" <?php echo(('' == $link->link_target) ? 'checked' : ''); ?>>
            ...
            <tr>
                ...
                <td><label>
                        <input type="radio" name="link_visible" <?php if ('Y' == $link->link_visible) {
                            echo 'checked';
                        } ?> value="Y">
                        <?php _e('Yes') ?></label><br><label>
                        <input type="radio" name="link_visible" <?php if ('N' == $link->link_visible) {
                            echo 'checked';
                        } ?> value="N">
                        <?php _e('No') ?></label></td>
            </tr>
