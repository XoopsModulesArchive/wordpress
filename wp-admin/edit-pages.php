            ...
            if (isset($_GET['s'])) {
                foreach ($posts as $post) :
                    ...
                    <tr id='page-<?php echo $post->ID; ?>' class='<?php echo $class; ?>'>
                        ...
                        <td><?php if (current_user_can('edit_pages')) {
                        echo "<a href='" . wp_nonce_url("post.php?action=delete&amp;post=$post->ID", 'delete-post_' . $post->ID) . "' class='delete' onclick=\"return deleteSomething( 'page', " . $id . ", '" . sprintf(
                            __('You are about to delete the &quot;%s&quot; page.\\n&quot;OK&quot; to delete, &quot;Cancel&quot; to stop.'),
                            js_escape(get_the_title('', '', 0))
                        ) . "' );\">" . __('Delete') . '</a>';
                    } ?></td>
                    </tr>
                <?php
