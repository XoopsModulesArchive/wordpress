...
class RSS_Import
{
    ...
    public function get_posts()
    {
        ...
        foreach ($this->posts as $post) {
            ...
            $post_title = str_replace(['<![CDATA[', ']]>'], '', $wpdb->escape(trim($post_title[1])));
            ...
            $post_content = str_replace(['<![CDATA[', ']]>'], '', $wpdb->escape(trim($post_content[1])));
...
register_importer('rss', __('RSS'), __('Import posts from an RSS feed'), [$rss_import, 'dispatch']);
