...
class LJ_Import
{
    ...
    public function import_posts()
    {
        ...
        foreach ($posts as $post) {
            ...
            $post_content = str_replace(['<![CDATA[', ']]>'], '', trim($post_content[1]));
            ...
            if ($comments) {
                ...
                foreach ($comments as $comment) {
                    ...
                    $comment_content = str_replace(['<![CDATA[', ']]>'], '', trim($comment_content[1]));
...
register_importer('livejournal', __('LiveJournal'), __('Import posts from LiveJournal'), [$livejournal_import, 'dispatch']);
