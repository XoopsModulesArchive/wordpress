...
if (!is_writable('../')) {
    die("Sorry, I can't write to the directory. You'll have to either change the permissions on your WordPress directory or create your wp-config.php manually.");
}
...
switch ($step) {
    case 0:
        ...
        <p><strong>If for any reason this automatic file creation doesn't work, don't worry. All this does is fill in the database information to a configuration file. You may also simply open <code>wp-config-sample.php</code> in a text editor, fill in your information, and save it as <code>wp-config.php</code>.
            </strong></p>
    ...
    case 2:
        ...
        require_once dirname(__DIR__) . '/wp-includes/wp-db.php';
        $handle = fopen('../wp-config.php', 'wb');

        foreach ($configFile as $line_num => $line) {
            switch (mb_substr($line, 0, 16)) {
                case "define('DB_NAME'":
