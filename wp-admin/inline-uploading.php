...
$wpvarstoreset = ['action', 'post', 'all', 'last', 'link', 'sort', 'start', 'imgtitle', 'descr', 'attachment'];
...
switch ($action) {
    ...
    case 'save':
        ...
        if (preg_match('!^image/!', $attachment['post_mime_type'])) {
            ...
            [$uwidth, $uheight] = get_udims($imagedata['width'], $imagedata['height']);
            ...
            if (3 * 1024 * 1024 > $imagedata['width'] * $imagedata['height']) {
...
";
                    ...
                    [$image['uwidth'], $image['uheight']] = get_udims($image['width'], $image['height']);
