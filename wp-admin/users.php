            ...
            <div class="wrap">
                ...
                <ul>
                    ...
                    foreach ($all_logins as $login) {
                        if ($login->ID == $current_user->id || !in_array($login->ID, $userids, true)) {
                ...
                <?php if ($go_delete) : ?>
                    ...
                    <ul style="list-style:none;">
                        <li><label><input type="radio" id="delete_option0" name="delete_option" value="delete" checked>
                ...
                <table cellpadding="3" cellspacing="3" width="100%">
                    ...
                    foreach ($roleclasses as $role => $roleclass) {
                        ...
                        foreach ($roleclass as $user_object) {
                            ...
                            if ($numposts > 0) {
                                $numposts = "<a href='edit.php?author=$user_object->ID' title='" . __('View posts') . "'>$numposts</a>";
                            }
