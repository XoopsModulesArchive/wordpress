...
if (!in_array('Snoopy', get_declared_classes(), true)) :
    class Snoopy
    {
        /**** Public variables ****/
        ...
        public $maxlength = 8192;                // max return data length (body)
        ...
        public function fetch($URI)
        {
            ...
            switch (mb_strtolower($URI_PARTS['scheme'])) {
                case 'http':
                        ...
                        if ($this->_redirectaddr) {
                            ...
                            if ($this->maxredirs > $this->_redirectdepth) {
                                ...
                                if (preg_match('|^http://' . preg_quote($this->host) . '|i', $this->_redirectaddr) || $this->offsiteok) {
                                    ...
                                    if (mb_strpos($this->_redirectaddr, '?') > 0) {
                                        $this->fetch($this->_redirectaddr);
