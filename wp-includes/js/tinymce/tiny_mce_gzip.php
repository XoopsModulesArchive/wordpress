...
@require dirname(__DIR__, 3) . '/wp-config.php';
@error_reporting(0);
...
$plugins = apply_filters('mce_plugins', ['wordpress', 'autosave', 'wphelp']);
...
$mce_buttons = apply_filters(
    'mce_buttons',
    ['bold', 'italic', 'strikethrough', 'separator', 'bullist', 'numlist', 'outdent', 'indent', 'separator', 'justifyleft', 'justifycenter', 'justifyright', 'separator', 'link', 'unlink', 'image', 'wordpress', 'separator', 'undo', 'redo', 'code', 'wphelp']
);
$mce_buttons = implode(',', $mce_buttons);
$mce_buttons_2 = apply_filters('mce_buttons_2', []);
$mce_buttons_2 = implode(',', $mce_buttons_2);
$mce_buttons_3 = apply_filters('mce_buttons_3', []);
$mce_buttons_3 = implode(',', $mce_buttons_3);
$mce_browsers = apply_filters('mce_browsers', ['msie', 'gecko', 'opera']);
