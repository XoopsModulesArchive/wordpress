...
if (!defined('WP_LANGUAGE_FILE_READ')) {
    ...
    define('_LANG_WA_CONFIG_USERNAME', 'visitante');
    ...
    define(
        '_LANG_WA_CONFIG_GUIDE5',
        '<strong>Se por alguma razão a criação automática de arquivos não funcionar, não se preocupe, pois tudo o que é feito é transferir os dados para um arquivo de configuração. Você também pode simplesmente abrir o arquivo <code>wp-config-sample.php</code> em um editor de textos, alterar as configurações, e salvá-lo como <code>wp-config.php</code>. </strong></p><p>Provavelmente, esses dados foram fornecidos à você pelo seu host. Se você ainda não tivé-los, precisará contatá-los antes de continuar. Caso você esteja pronto, clique <a href="install-config.php?step=1">aqui</a>.'
    );

    define('_LANG_WA_CONFIG_GUIDE6', 'Digite abaixo os dados da sua conexão ao banco de dados. Se você ainda não tiver certeza sobre eles, contate seu host.');

    define('_LANG_WA_CONFIG_GUIDE7', '<small>O nome do banco de dados onde o WordPress ME será instalado. </small>');

    define('_LANG_WA_CONFIG_GUIDE8', '<small>Nome de associado do MySQL</small>');

    define('_LANG_WA_CONFIG_GUIDE9', '<small>Senha do MySQL</small>');

    define('_LANG_WA_CONFIG_GUIDE10', '<small>Em 99% dos casos, você ainda não terá que mudar isto.</small>');
    ...
    define('_LANG_WA_WPDB_GUIDE2', 'Tem certeza de que o nome de associado/senha estão corretos?');
    ...
    define('_LANG_R_ENTER_LOGIN', '<strong>ERRO</strong>: escolha um nome de associado.');
    ...
    define('_LANG_R_CHOOSE_ANOTHER', '<strong>ERRO</strong>: este nome de associado já existe. Escolha outro e tente novamente.');

    define('_LANG_R_REGISTER_CONTACT', '<strong>ERRO</strong>: não foi possível realizar o cadastro. Contate o administrador.');

    define('_LANG_R_USER_REGISTRATION', 'Novo associado no seu blog');

    define('_LANG_R_MAIL_REGISTRATION', 'Novo cadastro de associado');
    ...
    define('_LANG_R_USER_LOGIN', 'visitante:');
    ...
    define('_LANG_L_LOGIN_EMPTY', 'Preencha o campo <b>visitante</b>.');

    define('_LANG_L_PASS_EMPTY', 'Preencha o campo <b>Senha</b>.');

    define('_LANG_L_WRONG_LOGPASS', 'O nome de associado ou senha são inválidos.');

    define('_LANG_L_RECEIVE_PASSWORD', 'Basta preencher os dados e te enviaremos uma nova senha.');

    define('_LANG_L_EXIST_SORRY', 'Este associado não existe. Clique <a href="wp-login.php?action=lostpassword">aqui</a> para receber sua senha por e-mail.');

    define('_LANG_L_YOUR_LOGPASS', 'visitante/senha do WordPress');
    ...
    define('_LANG_L_WRONG_SESSION', 'Erro: associado/senha inválidos.');
    ...
    define('_LANG_P_DATARIGHT_EDIT', ', você ainda não tem permissão para editar posts.');

    define('_LANG_P_DATARIGHT_DELETE', ', você ainda não tem permissão para apagar posts.');
    ...
    define('_LANG_P_NICKNAME_DELETE', 'Você ainda não tem permissão para apagar comentários.');
    ...
    define(
        '_LANG_P_WP_BOOKMARKLET',
        'Você pode arrastar o link seguinte para sua barra de links ou adicioná-lo ao seus Favoritos. Quando você clicar sobre ele, se abrirá uma janela popup com informações e um link para a página que você está visualizando agora, permitindo que você faça um post rapidamente.'
    );
    ...
    define('_LANG_C_RIGHT_EDITCAT', 'Você ainda não tem permissão para alterar as categorias deste blog.<br>Peça uma promoção ao administrador do blog.');
    ...
    define(
        '_LANG_EF_TRACK_FORM',
        '<p><label for="trackback"><a href="http://wordpress.org/docs/reference/post/#trackback" title="Ajuda com trackbacks">Fazer <strong>trackback</strong> numa <acronym title="Uniform Resource Locator">URL</acronym></a>:</label> (Separar múltiplas <acronym title="Uniform Resource Locator">URL</acronym>s por espaços.)<br>'
    );
    ...
    define('_LANG_WLC_RIGHT_PROM', 'Você ainda não tem permissão para editar as categorias de links deste blog.<br>Peça uma promoção ao administrador do blog.');
    ...
    define('_LANG_WLM_LEVEL_ERROR', 'Você ainda não tem permissão para editar os links para este blog.<br>Peça uma promoção ao administrador do blog.');
    ...
    define('_LANG_WPM_USER_LEVEL', 'Você ainda não tem permissão para moderar comentários. Peça uma promoção ao administrador do blog.');
    ...
    define(
        '_LANG_WPM_ASKED_AGAIN',
        '<p><em>Apagar</em>: remove o conteúdo do blog (NOTA: você ainda não será consultado novamente, portanto tenha a certeza de que deseja realmente remover o comentário - uma vez apagados, eles não poderão ser recuperados!)</p><p><em>Deixar para depois</em>: não muda o estado dos comentários.</p>'
    );
    ...
    define('_LANG_WOP_USER_LEVEL', 'Você ainda não tem permissão para editar as opções deste blog.<br>Peça uma promoção ao administrador do blog.');
    ...
    define(
        '_LANG_WPL_USE_EXAMPLE',
        'Um valor como <code>/archives/%year%/%monthnum%/%day%/%postname%/</code> daria um permalink como <code>/archives/2003/05/23/my-cheese-sandwich/</code>. Para que isso funcione, você deverá ter o mod_rewrite instalado em seu servidor para a criação das regras. Futuramente, poderão haver mais opções.'
    );
    ...
    define(
        '_LANG_WPL_USE_BLANK',
        'Se você quiser, você pode digitar um prefixo personalizado para a sua categoria de URIs aqui. Ex.: <code>/taxonomy/categorias</code> faria seus links de categoria ficarem como <code>http://examplo.org/taxonomy/categorias/general/</code>. Se você deixar isto em branco, as configurações padrões serão usadas.'
    );
    ...
    define('_LANG_WPL_MOD_REWRITE', 'No momento, você ainda não esta usando permalinks personalizados. Nenhuma regra especifica do mod_rewrite é necessária.');

    define('_LANG_WPL_SUBMIT_UPDATE', 'Enviar');

    /* File Name wp-admin/profile.php */

    define('_LANG_WPF_ERR_NICKNAME', '<strong>ERRO</strong>: digite seu nick (pode ser o mesmo que o seu nome de associado).');
    ...
    define(
        '_LANG_WPF_SUBT_BOOK',
        'Salve-o como wordpress.reg, e clique duas vezes nele numa janela do Explorer.<br>Responda \"Sim\" a pergunta, e reinicie o Internet Explorer.<br><br>Assim, você pode clicar com o botão direito numa janela do Internet Explorer<br>e selecionar "Postar no WP".'
    );
    ...
    define('_LANG_WPF_SUBT_LOGIN', 'visitante:');
    ...
    define('_LANG_WAT_LEVEL_ERR', '<p>Você ainda não tem permissão para editar o template deste blog.<br>Peça uma promoção ao administrador do blog.</p>');
    ...
    define('_LANG_WAT_FILE_CHMOD', 'Você ainda não pode editar este arquivo/template. Ele deve ter permissão de escrita. Ex.: CHMOD 766');
    ...
    define('_LANG_WAT_FTP_CLIENT', 'Nota: É claro, você pode editar os arquivos/templates em seu editor de textos favorito e fazer o upload. Este editor on-line só deve ser usado caso você ainda não tem um editor de textos ou cliente de FTP.');
    ...
    define('_LANG_WUS_WHOSE_LEVEL', 'Não é possível alterar o nível de um associado cujo nível é maior que o seu.');

    define('_LANG_WUS_WHOSE_DELETE', 'Não é possível apagar um associado cujo nível é maior que o seu.');

    define('_LANG_WUS_CANNOT_DELU', 'Não é possível apagar este associado.');

    define('_LANG_WUS_CANNOT_DELUPOST', 'Não é possível apagar os posts desse associado');
    ...
    define('_LANG_WUS_AU_USERS', 'visitantes');

    define('_LANG_WUS_AU_WARNING', 'Para apagar um associado, mude seu nível para 0, e então clique no X vermelho.<br><strong>ATENÇÃO:</strong> apagar um associado remove também todos os posts feitos por ele.');

    define('_LANG_WUS_ADD_USER', 'Adicionar associado');

    define('_LANG_WUS_ADD_THEMSELVES', 'Os associados podem registrar-se por si mesmos ou você pode criá-los manualmente por aqui.');
    ...
    define('_LANG_WAU_UPLOAD_DIRECTORY', 'Você ainda não pode fazer o upload de arquivos pois o diretorio especificado não tem permissão de escrita pelo WordPress. Cheque as permissões dos diretórios ou erros.');
    ...
    define('_LANG_WAO_GENERAL_DISABLED', 'Você ainda não tem permissão suficiente para editar as opções para este blog.');
    ...
    define('_LANG_WAO_GENERAL_MEMBER', 'visitante:');
    ...
    define('_LANG_WAO_GENERAL_ARTICLES', 'Permitir a qualquer associado cadastrado postar artigos.');

    define('_LANG_WAO_GENERAL_UPDATE', 'Enviar');

    /* File Name wp-admin/options-writing.php */

    define('_LANG_WAO_WRITING_ERROR', 'Você ainda não tem permissão para editar as opções para este blog.');
    ...
    define('_LANG_P_CHEATING_ERROR', 'Você ainda não tem permissão para realizar esta operação.');
    ...
    define(
        '_LANG_INST_GUIDE_COM',
        'Você também deve determinar as configurações do banco de dados no <code>wp-config.php</code>. Você deve alterar a permissão do arquivo weblogs.com.changes.cache para 666.<br>Veja o leia-me <a href="../wp-readme/">aqui</a>.</p> Se você estiver pronto, clique <a href="install.php?step=1">aqui</a>.'
    );
    ...
    define('_LANG_INST_BASE_VALUE7', 'Permitir que novos associados possam postar depois de cadastrados.');
    ...
    define('_LANG_INST_BASE_VALUE28', 'Você ainda não deve precisar mudar isto.');
    ...
    define('_LANG_INST_BASE_VALUE35', 'Por padrão, na maioria dos servidores o upload de arquivos á 2048 KB. Para determinar um valor menor, mude isto. (você ainda não poderá determinar um valor maior do que o limite do seu servidor)');

    define('_LANG_INST_BASE_VALUE36', 'Caso não queira permitir o upload de arquivos à todos os associados, escolha um nível mínimo,');

    define('_LANG_INST_BASE_VALUE37', 'Ou você pode especificar apenas alguns associados. Digite seus nomes de associado, separados por espaço. Se você deixar esta variável em branco, todos os associados com o nível mínimo poderão fazer o upload de arquivos.');

    /* email settings */

    define('_LANG_INST_BASE_VALUE38', 'Servidor de e-mail.');

    define('_LANG_INST_BASE_VALUE39', 'Nome de associado.');
    ...
    define('_LANG_INST_BASE_VALUE47', 'Se você ativou a opção acima, quando redigir uma mensagem, você terá que digitar o assunto, o string separador, associado:senha, o string separador, e o conteúdo.');
    ...
    define('_LANG_INST_STEP2_URL', 'visitante criado com sucesso.');

    define('_LANG_INST_STEP3_SET', '<p>Agora você pode se <a href="../wp-login.php">identificar</a> com o <strong>associado</strong> "admin" e <strong>senha</strong> "');
    ...
    define('_LANG_INST_BASE_VALUE91', 'Se o arquivo de destino deve ser Gzip ou não. Ative-o se você ainda não tiver mod_gzip rodando ainda.');
    ...
    define(
        '_LANG_PG_NEED_PUT',
        'Plug-ins são arquivos especiais que servem para adicionar novas opções no WordPress. Para instalar um plug-in, basta colocar os arquivos no diretório <code>wp-content/plugins</code>. Caso queira instalar um plug-in temporariamente, é possível ativá-lo e desativá-lo nesta página.'
    );
    ...
    define(
        '_LANG_PG_TEXTILE_1',
        'Este é um wrapper simples para o Humane Web Text Generator de <a href="http://textism.com/?wp">Dean Allen</a>, também conhecido como <a href="http://www.textism.com/tools/textile/">Textile</a>. Se você ativar este plug-in, deve desativar o Textile 2 e Markdown, pois eles não funcionam muito bem juntos.'
    );
}
