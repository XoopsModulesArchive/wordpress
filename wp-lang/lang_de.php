...
if (!defined('WP_LANGUAGE_FILE_READ')) {
    ...
    define(
        ...
        'Als Newcomer musst Du warten bis Dich ein Admin auf Level 1 setzt. Erst dann darfst Du posten.<br>Du kannst auch eine Mail schreiben mit der Bitte um Dich auf Level 1 zu setzen.<br>Wenn Du bef&ouml;rdert wurdest, brauchst Du die Seite nur neu zu laden um zu bloggen. :)'
    );
    ...
    define(
        '_LANG_EF_TRACK_FORM',
        '<p><label for="trackback"><a href="http://wordpress.org/docs/reference/post/#trackback" title="Help on trackbacks"><strong>TrackBack</strong> an <acronym title="Uniform Resource Locator">URL</acronym></a>:</label> (Mehrere <acronym title="Uniform Resource Locator">URL</acronym>s mit Leerzeichen trennen.)<br>'
    );
    ...
    define(
        ...
        '<p><em>L&ouml;schen</em>: Entfernt den Inhalt aus dem Blog (Beachte: Es gibt keine weitere Abfrage, die Entscheidung den Kommentar zu l&ouml;schen sollte also gut bedacht sein - einmal gel&ouml;scht immer gel&ouml;scht!)</p><p><em>Sp&auml;ter</em>: &Auml;ndert den Kommentar-Status nicht.</p>'
    );
