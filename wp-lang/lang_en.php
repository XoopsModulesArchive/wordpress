...
if (!defined('WP_LANGUAGE_FILE_READ')) {
    ...
    define(
        ...
        '<strong>If for any reason this automatic file creation doens\'t work, don\'t worry. All this does is fill in the database information to a configuration file. You may also simply open <code>wp-config-sample.php</code> in a text editor, fill in your information, and save it as <code>wp-config.php</code>. </strong></p>
<p>In all likelyhood, these items were supplied to you by your ISP. If you do not have this information, then you will need to contact them before you can continue. If you&#8217;re all ready, <a href="install-config.php?step=1">let&#8217;s go</a>! '
    ...
    define(
        '_LANG_P_NEWCOMER_MESS',
        'Since you&#8217;re a newcomer, you&#8217;ll have to wait for an admin to raise your level to 1, in order to be authorized to post.<br>You can also e-mail the admin to ask for a promotion.<br>When you&#8217;re promoted, just reload this page and you&#8217;ll be able to blog. :)'
    );
    ...
    define(
        '_LANG_EF_TRACK_FORM',
        '<p><label for="trackback"><a href="http://wordpress.org/docs/reference/post/#trackback" title="Help on trackbacks"><strong>TrackBack</strong> an <acronym title="Uniform Resource Locator">URL</acronym></a>:</label> (Separate multiple <acronym title="Uniform Resource Locator">URL</acronym>s with spaces.)<br>'
    );
    ...
    define(
        '_LANG_WLI_ROLL_OPMLLINK',
        'Or go to Blo.gs and sign in. Once you&#8217;ve done that in the &#8217;Welcome Back&#8217; box on the right, click on <strong>share</strong>, and then look for the <strong><abbr title="Outline Processor Markup Language">OPML</abbr> link</strong> (favorites.opml)'
    );
    ...
    define(
        ...
        '<p><em>delete</em>: remove the content from your blog (note: you won&#8242;t be asked again, so you should double-check that you really want to delete the comment - once deleted you can&#8242;t bring them back!)</p><p><em>later</em>: don&#8242;t change the comment&#8242;s status at all now.</p>'
    );
...
<p>If you use this option you can ignore the mod_rewrite rules. </p>'
    ...
    define(
        '_LANG_WPL_USE_BLANK',
        'If you like, you may enter a custom prefix for your category URIs here. For example, <code>/taxonomy/categorias</code> would make your category links like <code>http://example.org/taxonomy/categorias/general/</code>. If you leave this blank the default will be used.'
    );
    ...
    define(
        '_LANG_WPF_SUBT_BOOK',
        'Save it as wordpress.reg, and double-click on this file in an Explorer<br>window. Answer Yes to the question, and restart Internet Explorer.<br><br>That&#8242;s it, you can now right-click in an IE window and select <br>&#8242;Post to WP&#8242; to make the bookmarklet appear. :)'
    );
    ...
    define(
        '_LANG_INST_GUIDE_WEL',
        '<br>Welcome to WordPress. We&#8217;re now going to go through a few steps to get you up and running with the latest in personal publishing platforms. Before we get started, remember that we require a PHP version of at least 4.0.6, you
  have '
    );

    define(
        '_LANG_INST_GUIDE_COM',
        '. Look good? You also need to set up the database connection information in <code>wp-config.php</code>. Have you looked at the <a href="../wp-readme/">readme</a>? If you&#8217;re all ready, <a href="install.php?step=1">let\'s
  go</a>! '
    );
    ...
    define(
        '_LANG_INST_STEP3_UP',
        '".</p><p><strong><em>Note that password</em></strong> carefully! It is a <em>random</em> password that was generated just for you. If you lose it, you
  will have to delete the tables from the database yourself, and re-install WordPress.</p>'
    ...
    define(
        '_LANG_PG_NEED_PUT',
        'Plugins are files you usually download seperately from WordPress that add functionality. To install a plugin you generally just need to put the plugin file into your <code>wp-content/plugins</code> directory. Once a plugin is installed, you may activate it or deactivate it here.'
    );
    ...
    define(
        '_LANG_PG_TEXTILE_1',
        'This is a simple wrapper for <a href="http://textism.com/?wp">Dean Allen\'s</a> Humane Web Text Generator, also known as <a href="http://www.textism.com/tools/textile/">Textile</a>. If you use this plugin you should disable Textile 2 and Markdown, as they don\'t play well together.'
    );
}
