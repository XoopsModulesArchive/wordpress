...
/* Don't remove this line */ if (!defined('XOOPS_ROOT_PATH')) {
    exit;
}
...
EOD;
/* Don't remove this line */ if (!defined('WP_BLOCK_CSS_READ')) {
    define('WP_BLOCK_CSS_READ', '1');
...
/* Don't remove this line */ global $wp_id,$wp_filter; if ((@in_array('pukiwiki', $wp_filter[$wp_id]['the_content']['6'], true)) and
/* Don't remove this line */ (!preg_match('/^' . preg_quote(XOOPS_ROOT_PATH . '/modules/wordpress' . $wp_num . '/', '/') . '/i', $cur_PATH))) {/* Don't remove this line */ if (!defined('WP_BLOCK_WIKI_READ')) {
    /* Don't remove this line */ define('WP_BLOCK_WIKI_READ', '1');
