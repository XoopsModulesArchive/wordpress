...
{
    if (mb_strstr($url = kubrick_header_image_url(), 'header-img.php?')) {
        parse_str(mb_substr($url, mb_strpos($url, '?') + 1), $q);
            ...
            if (isset($_REQUEST['njform'])) {
                if (isset($_REQUEST['defaults'])) {
                    ...
                    if (preg_match('/[0-9A-F]{6}|[0-9A-F]{3}/i', $_REQUEST['njuppercolor'], $uc) && preg_match('/[0-9A-F]{6}|[0-9A-F]{3}/i', $_REQUEST['njlowercolor'], $lc)) {
                        $uc = (3 == mb_strlen($uc[0])) ? $uc[0][0] . $uc[0][0] . $uc[0][1] . $uc[0][1] . $uc[0][2] . $uc[0][2] : $uc[0];

                        $lc = (3 == mb_strlen($lc[0])) ? $lc[0][0] . $lc[0][0] . $lc[0][1] . $lc[0][1] . $lc[0][2] . $lc[0][2] : $lc[0];
