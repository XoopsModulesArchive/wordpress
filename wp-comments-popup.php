    ...
    <?php if ('open' == $post->comment_status) { ?>
        ...
        <form action="<?php echo $siteurl; ?>/wp-comments-post.php" method="post" id="commentform">
            <p>
                ...
                <input type="hidden" name="redirect_to" value="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'], ENT_QUOTES | ENT_HTML5); ?>">
            </p>
...
<p class="credit"><?php timer_stop(1); ?> <cite>Turbinado pelo <a href="http://wordpress.org"><strong>Wordpress</strong></a></cite></p>
